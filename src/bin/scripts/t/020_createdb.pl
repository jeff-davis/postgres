...
$node->command_ok(
	[
		'createdb', '-T', 'template0', '--locale-provider=builtin', 'tbuiltin1'
	],
...
$node->command_ok(
	[
		'createdb', '-T', 'template0', '--locale-provider=builtin', '--locale=C',
		'tbuiltin2'
	],
...
$node->command_ok(
	[
		'createdb', '-T', 'template0', '--locale-provider=builtin', '--lc-ctype=C',
		'tbuiltin4'
	],
...
$node->command_fails(
	[
		'createdb', '-T', 'template0', '--locale-provider=builtin', '--icu-locale=en',
		'tbuiltin5'
	],
...
$node->command_fails(
	[
		'createdb', '-T', 'template0', '--locale-provider=builtin', '--icu-rules=""',
		'tbuiltin6'
	],
