...
SELECT fdwname, fdwhandler::regproc, fdwvalidator::regproc, fdwoptions
  FROM pg_foreign_data_wrapper WHERE fdwname LIKE 'regress\_%' ORDER BY 1, 2, 3;
...
DROP FOREIGN DATA WRAPPER regress_nonexistent;                      -- ERROR
DROP FOREIGN DATA WRAPPER IF EXISTS regress_nonexistent;
\dew+ regress_*
...
-- test SERVER ... FOREIGN DATA WRAPPER pg_connection_fdw
